...
public class BookingService {
    ...
    public Booking crearReserva(Long userId, Long toolId, LocalDate fechaInicio, LocalDate fechaFin) {
        ...
        if (!"DISPONIBLE".equals(herramienta.getStatus())) {
    ...
    public List<Booking> filtrarReservas(LocalDate inicio, LocalDate fin) {
        if (inicio == null || fin == null) {
            return bookingRepository.findAll();
        }

        return bookingRepository.findByStartDateBetween(inicio, fin);
    }
}